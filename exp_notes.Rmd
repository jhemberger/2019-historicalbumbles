...
__April 2, 2020:__
Talked with Tim about modeling in the paper, and re-ran spatial autocorrelation tests.  Three species show significant spatial autocorrleation in 2012 (year with most spatial unites - counties).  Ran spatial error models for these species (results are identical), but at least we have peace of mind that we are accounting for spatial autocorrelation when it exists.  
