...
test <- relabun_bycty.df %>%
  ...
  filter(species %in% c("Bombus impatiens", "Bombus terricola"))
```
...
species.2.glms <- function(data) {
  ...
  for (i in species.list) {
    ...
    trend.plot <- ggplot() + 
      ...
      xlab(label = "Year") + 
      labs(title = paste(i,
                         "proportional abundance 1982-present",
                         sep = " "))
    # ggsave(plot = trend.plot,
    #        filename = paste("./model_plots/trends/",
    #                         i,
    ...
    #   #                    breaks = seq(1870, 2020, by = 20)) +
    #   ylab(label = "Proportional Abundance") +
    #   xlab(label = "Proportion of county in cover crop") +
    #   labs(title = i)
    # ggsave(plot = ncrop.plot,
    #        filename = paste("./model_plots/ncrops/",
    #                         i,
    ...
    # avgfarm.plots.list[[i]] <- propcc.plot
  }
